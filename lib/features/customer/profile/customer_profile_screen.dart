    ...
    final content = Column(children: [
          ...
          child: Column(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(image: AssetImage('assets/images/user_avatar.jpg'), fit: BoxFit.cover),
              ),
            ),
      ...
      Expanded(child: SingleChildScrollView(padding: const EdgeInsets.all(20), child: Column(children: [
        _section('Account Details', [
          _tile(Icons.person_outline, 'Personal Information', 'Update name, email & phone', () => Navigator.pushNamed(context, '/customer/profile/personal-info')),
          ...
          _tile(Icons.credit_card, 'Payment Methods', 'Cards, wallets & billing', () => Navigator.pushNamed(context, '/customer/profile/payment-methods')),
          _tile(Icons.location_on_outlined, 'Saved Addresses', 'Home, work & frequent stops', () => Navigator.pushNamed(context, '/customer/profile/saved-addresses')),
        ]),
        const SizedBox(height: 16),
        _section('Preferences', [
          _tile(Icons.notifications_none_outlined, 'Notification Settings', 'Alerts and push notifications', () => Navigator.pushNamed(context, '/customer/profile/notification-settings')),
          _tile(Icons.language, 'Language & Region', 'English (Bahamas)', () => Navigator.pushNamed(context, '/customer/profile/language-region')),
          _tile(Icons.dark_mode_outlined, 'Appearance', 'Dark Mode • Active', () => Navigator.pushNamed(context, '/customer/profile/appearance')),
        ]),
        const SizedBox(height: 16),
        _section('Support & Legal', [
          ...
          _tile(Icons.policy_outlined, 'Privacy Policy', 'How we use your data', () => Navigator.pushNamed(context, '/customer/profile/privacy-policy')),
          _tile(Icons.article_outlined, 'Terms of Service', 'User agreement', () => Navigator.pushNamed(context, '/customer/profile/terms-of-service')),
        ]),
        const SizedBox(height: 20),
