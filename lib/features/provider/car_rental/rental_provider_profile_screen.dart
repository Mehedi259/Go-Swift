...
class RentalProviderProfileScreen extends StatelessWidget {
  const RentalProviderProfileScreen({super.key});
  @override
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(backgroundColor: AppColors.background, title: Text('Fleet Owner Profile', style: AppTextStyles.titleLarge),
    ...
    body: Center(child: Text('Fleet Owner Profile', style: AppTextStyles.headlineMedium)),
  );
}
